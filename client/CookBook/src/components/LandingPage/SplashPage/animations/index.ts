...
export const fadeUp = (el: gsap.TweenTarget, delay = 0) => {
  tl.from(el, {
    y: 150,
    duration: 1,
    delay,
...
export const boxHover = (e: { target: { querySelector: (arg0: string) => gsap.TweenTarget; querySelectorAll: (arg0: string) => gsap.TweenTarget; }; }) => {
  const tl = gsap.timeline();
...
export const boxExit = (e: { target: { querySelector: (arg0: string) => gsap.TweenTarget; }; }) => {
  window.innerWidth >= 986 &&
...
export const fadeIn = (el: gsap.TweenTarget) => {
  gsap.to(el, {
    duration: 2,
    opacity: 1,
    y: -60,
...
export const fadeOut = (el: gsap.TweenTarget) => {
  gsap.to(el, {
    duration: 1,
    opacity: 0,
    y: -20,
